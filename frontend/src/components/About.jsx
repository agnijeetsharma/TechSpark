    ...
    <div className="bg-base text-base-content-h-screen flex flex-col items-center px-6 py-10 mt-14">
      <div className="max-w-4xl  text-center">
        ...
        <p className="text-lg mb-6">
          ...
          Our goal is to create a space where innovation, collaboration, and skill-building come together to help you succeed 
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-10 max-w-5xl">
        <div className="flex-1 bg-base-200 p-6 rounded-lg shadow-lg">
          ...
          <p className="text-base">
            ...
            resources to shape the next generation of tech leaders. We strive to inspire creativity and support learning 
        ...
        <div className="flex-1 bg-base-200 p-6 rounded-lg shadow-lg">
          ...
          <p className="text-base">
            ...
            We aim to build a global network of tech professionals who thrive in a rapidly changing digital world.
          </p>
        </div>
      </div>
      ...
      <div className="mt-10 bg-base-200 p-6 rounded-lg shadow-lg max-w-5xl">
        ...
        <ul className="list-disc list-inside text-base">
          ...
          <li className="mb-2">Access to the latest tools, resources, and technologies.</li>
          <li className="mb-2">Opportunities to collaborate, innovate, and grow.</li>
          <li className="mb-2">A platform tailored for developers to showcase their skills and network.</li>
        </ul>
      </div>
