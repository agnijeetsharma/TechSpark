...
import { CreateProfile,updateProfile, updateProfileImage,AllProfiles } from "../controllers/profile.controller.js";
const router = Router();
...
router.route("/register").post(
    ...
    router.route("/update-profileImage/:username").post(verifyJWT, 
        upload.fields(
            [
                {
                 name:"profileImage",
